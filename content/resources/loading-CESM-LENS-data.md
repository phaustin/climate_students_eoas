...
Preliminary:  You'll need to install `s3fs` into e440:

```
conda install -c conda-forge s3fs
```

This notebook demonstrates how to access Google Cloud CMIP6 data, specifically CESM-LENS, using intake-esm.
...
```python
# Let's look at how sea level pressure has changed over time in different ensemble members, 
